...
class TiposIncidencia(Ventana):
    def __init__(self, objeto = None, usuario = None):
        ...
        connections = {'b_salir/clicked': self.salir,
                       ...
                       'b_modificar/clicked': self.modificar_tipo_de_incidencia}
        self.add_connections(connections)
        cols = (('Tipo de incidencia','gobject.TYPE_STRING',False,True,False,None),
                ('Idtipodeincidencia','gobject.TYPE_INT64',False,False,False,None))
