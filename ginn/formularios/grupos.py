...
class Grupos(Ventana):
    ...
    def es_diferente(self):
        ...
        condicion = True
        for col in grupo.sqlmeta.columns:
            condicion = condicion and self.comparar_campo(col, grupo.sqlmeta.columns[col])
...
#                self.logger.error(txt)
    ...
    def guardar(self, widget):
        ...
        for col in grupo.sqlmeta.columns:
            valor = self.get_valor(self.wids[col], col, grupo.sqlmeta.columns[col])
            try:
