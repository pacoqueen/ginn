...
puntoglade = 'resultados_compresion.glade'    # Archivo glade
claseprueba = pclases.PruebaCompresion    # Clase de pclases.
nombrecampo = 'pruebasCompresion'       # Campo de "partida".
nombreprueba = 'compresion'   # Nombre de la prueba (media de resultados) en la partida.
titulo = 'Resultados de compresión'
# XXX

class ResultadosCompresion(Ventana):
