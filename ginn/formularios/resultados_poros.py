...
puntoglade = 'resultados_poros.glade'    # Archivo glade
claseprueba = pclases.PruebaPoros    # Clase de pclases.
nombrecampo = 'pruebasPoros'       # Campo de "partida".
nombreprueba = 'poros'   # Nombre de la prueba (media de resultados) en la partida.
titulo = 'Resultados de apertura de poros'
# XXX

class ResultadosPoros(Ventana):
