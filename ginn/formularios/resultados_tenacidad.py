...
###################################################################
## resultados_tenacidad.py - Resultados de pruebas de tenacidad.   
###################################################################
## NOTAS:
##  
###################################################################
...
class ResultadosTenacidad(Ventana):
    ...
    def rellenar_pruebas(self):
        ...
        pruebas = pclases.PruebaTenacidad.select(pclases.PruebaTenacidad.q.loteID == self.lote.id)
    ...
    def calcular_caracteristicas(self):
        ...
        # De aquí para abajo no es necesario en esta ventana. Sí en el resto de resultados*.py
        #mediaElongacion = 0
