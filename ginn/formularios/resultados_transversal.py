...
puntoglade = 'resultados_transversal.glade'    # Archivo glade
claseprueba = pclases.PruebaTransversal    # Clase de pclases.
nombrecampo = 'pruebasResistenciaTransversal'       # Campo de "partida".
nombreprueba = 'transversal'   # Nombre de la prueba (media de resultados) en la partida.
titulo = 'Resultados de alargamiento transversal'
# XXX

class ResultadosTransversal(Ventana):
