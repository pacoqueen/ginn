...
###################################
# NOTAS:
# Esto necesita PIL y ReportLab.
###################################
# TODO:
# Hay que hacer mejor y más ligero todo el módulo en general; pero especialmente
# lo de generar 3of9. Especificaciones de la implementacion:
...
Créditos a quien corresponda. Creo que lo saqué del python-recipes.
Modificado ligeramente para devolver la imagen de PIL en vez de guardarla
