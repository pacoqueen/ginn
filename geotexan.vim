...
" Created by session.vim 1.5 on 01 abril 2014 at 17:35:29.
...
1052
normal! zo
let s:l = 1055 - ((6 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1055
...
21094
normal! zo
let s:l = 9871 - ((1 * winheight(0) + 4) / 8)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9871
