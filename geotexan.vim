...
" Created by session.vim 1.5 on 21 octubre 2014 at 08:15:12.
...
3362
normal! zo
let s:l = 3389 - ((3 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3389
...
752
normal! zo
let s:l = 742 - ((12 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
742
...
3960
normal! zo
let s:l = 1862 - ((6 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1862
