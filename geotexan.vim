...
" Vim session script.
" Created by session.vim 2.13.1 on 04 diciembre 2017 at 17:11:37.
...
badd +2982 formularios/partes_de_fabricacion_rollos.py
...
exe 'vert 1resize ' . ((&columns * 28 + 71) / 143)
exe '2resize ' . ((&lines * 5 + 28) / 57)
exe 'vert 2resize ' . ((&columns * 114 + 71) / 143)
exe '3resize ' . ((&lines * 45 + 28) / 57)
exe 'vert 3resize ' . ((&columns * 114 + 71) / 143)
exe '4resize ' . ((&lines * 1 + 28) / 57)
exe 'vert 4resize ' . ((&columns * 114 + 71) / 143)
exe '5resize ' . ((&lines * 1 + 28) / 57)
exe 'vert 5resize ' . ((&columns * 114 + 71) / 143)
argglobal
enew
file __Tagbar__.1
wincmd w
argglobal
let s:l = 102 - ((3 * winheight(0) + 2) / 5)
...
let s:l = 366 - ((1 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
366
