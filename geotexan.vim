...
" Created by session.vim 1.5 on 05 marzo 2015 at 17:13:10.
...
setlocal fdn=20
setlocal fen
let s:l = 3371 - ((20 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3371
...
19789
normal! zo
let s:l = 19272 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19272
...
4226
normal! zo
let s:l = 1100 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1100
