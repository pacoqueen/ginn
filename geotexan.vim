...
" Created by session.vim 1.5 on 19 diciembre 2014 at 14:40:42.
...
16891
normal! zo
let s:l = 16867 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16867
...
3736
normal! zo
let s:l = 3685 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3685
...
4208
normal! zo
let s:l = 1403 - ((12 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1403
