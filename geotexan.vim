...
" Created by session.vim 1.5 on 15 mayo 2015 at 16:19:50.
...
20827
normal! zo
let s:l = 20945 - ((0 * winheight(0) + 0) / 1)
...
setlocal fdn=20
setlocal fen
let s:l = 103 - ((7 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
