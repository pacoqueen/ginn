...
" Created by session.vim 1.5 on 23 enero 2014 at 17:27:57.
...
20440
normal! zo
let s:l = 10581 - ((14 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10581
...
2079
normal! zo
let s:l = 2059 - ((9 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2059
...
4599
normal! zo
let s:l = 2096 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2096
