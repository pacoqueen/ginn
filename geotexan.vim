...
" Created by session.vim 1.5 on 11 junio 2014 at 21:17:09.
...
badd +0 ginn/formularios/consulta_pedidos_clientes.py
argglobal
silent! argdel *
...
16736
normal! zo
let s:l = 17294 - ((0 * winheight(0) + 1) / 3)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17294
...
198
normal! zo
let s:l = 150 - ((11 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
150
