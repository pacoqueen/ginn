...
" Created by session.vim 1.5 on 03 marzo 2015 at 10:48:49.
...
2379
normal! zo
let s:l = 1245 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1245
...
19789
normal! zo
let s:l = 19272 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19272
...
4226
normal! zo
let s:l = 1100 - ((0 * winheight(0) + 3) / 7)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1100
