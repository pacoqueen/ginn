...
" Created by session.vim 1.5 on 13 noviembre 2014 at 13:22:14.
...
exe 'vert 10resize ' . ((&columns * 82 + 50) / 101)
argglobal
enew
file __Tag_List__
setlocal fdm=manual
...
1513
normal! zo
let s:l = 1467 - ((0 * winheight(0) + 1) / 3)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1467
