...
" Created by session.vim 1.5 on 22 diciembre 2015 at 10:05:11.
...
444
normal! zo
let s:l = 450 - ((0 * winheight(0) + 5) / 11)
...
21606
normal! zo
let s:l = 11589 - ((0 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11589
