...
" Created by session.vim 1.5 on 10 marzo 2015 at 09:39:53.
...
2379
normal! zo
let s:l = 1245 - ((0 * winheight(0) + 4) / 8)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1245
...
19799
normal! zo
let s:l = 16884 - ((2 * winheight(0) + 4) / 8)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16884
...
4232
normal! zo
let s:l = 1106 - ((0 * winheight(0) + 4) / 8)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1106
