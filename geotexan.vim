...
" Created by session.vim 1.5 on 01 marzo 2016 at 18:18:18.
...
697
normal! zo
let s:l = 566 - ((13 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
566
...
21749
normal! zo
let s:l = 2874 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2874
