...
" Created by session.vim 1.5 on 18 septiembre 2015 at 13:25:25.
...
20854
normal! zo
let s:l = 20906 - ((4 * winheight(0) + 4) / 8)
...
1271
normal! zo
let s:l = 1277 - ((3 * winheight(0) + 3) / 7)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1277
...
3596
normal! zo
let s:l = 1436 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1436
