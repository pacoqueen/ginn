...
" Created by session.vim 1.5 on 06 agosto 2014 at 12:44:51.
...
816
normal! zo
let s:l = 825 - ((4 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
825
...
447
normal! zo
let s:l = 198 - ((1 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
198
