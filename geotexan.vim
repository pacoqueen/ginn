...
" Vim session script.
" Created by session.vim 2.13.1 on 28 junio 2017 at 15:32:48.
...
badd +2975 formularios/partes_de_fabricacion_rollos.py
...
badd +4787 framework/pclases/__init__.py
...
wincmd w
argglobal
let s:l = 355 - ((1 * winheight(0) + 9) / 18)
...
let s:l = 2585 - ((16 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2585
...
let s:l = 4790 - ((5 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4790
...
1resize 63|vert 1resize 24|2resize 18|vert 2resize 92|3resize 22|vert 3resize 92|4resize 4|vert 4resize 92|5resize 16|vert 5resize 92|
3wincmd w
tabnext 1
if exists('s:wipebuf')
