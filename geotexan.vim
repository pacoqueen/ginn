...
" Created by session.vim 1.5 on 17 julio 2014 at 14:54:26.
...
exe '10resize ' . ((&lines * 7 + 24) / 48)
exe 'vert 10resize ' . ((&columns * 85 + 57) / 115)
exe '11resize ' . ((&lines * 22 + 24) / 48)
...
395
normal! zo
let s:l = 186 - ((12 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
