...
" Created by session.vim 1.5 on 02 octubre 2014 at 17:23:05.
...
badd +0 ginn/formularios/consulta_vencimientos_pago.py
...
setlocal fdn=20
setlocal fen
let s:l = 1600 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1600
...
793
normal! zo
let s:l = 393 - ((20 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
393
