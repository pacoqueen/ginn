...
" Created by session.vim 1.5 on 01 diciembre 2015 at 18:28:16.
...
badd +665 ginn/api/murano/ops.py
...
678
normal! zo
let s:l = 676 - ((29 * winheight(0) + 21) / 43)
