...
" Created by session.vim 1.5 on 10 abril 2014 at 18:40:17.
...
21094
normal! zo
let s:l = 3339 - ((2 * winheight(0) + 3) / 7)
...
setlocal fdn=20
setlocal fen
let s:l = 153 - ((28 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
