...
" Created by session.vim 1.5 on 28 marzo 2014 at 20:16:27.
...
4248
normal! zo
let s:l = 4813 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4813
...
3511
normal! zo
let s:l = 1518 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1518
...
21094
normal! zo
let s:l = 9554 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9554
