...
" Created by session.vim 1.5 on 11 julio 2013 at 10:50:51.
...
badd +968 ginn/formularios/productos_de_venta_rollos.py
...
setlocal fdn=20
setlocal fen
let s:l = 1171 - ((3 * winheight(0) + 3) / 7)
...
19738
silent! normal zo
let s:l = 3119 - ((16 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3119
