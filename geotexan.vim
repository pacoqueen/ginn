...
" Vim session script.
" Created by session.vim 2.13.1 on 10 noviembre 2017 at 16:03:12.
...
wincmd w
argglobal
let s:l = 9828 - ((0 * winheight(0) + 0) / 1)
...
let s:l = 405 - ((15 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
405
...
let s:l = 878 - ((1 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
878
