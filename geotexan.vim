...
" Created by session.vim 1.5 on 11 enero 2016 at 09:59:51.
...
badd +11611 ginn/framework/pclases/__init__.py
...
21606
normal! zo
let s:l = 11617 - ((2 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11617
...
1459
normal! zo
let s:l = 1451 - ((36 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1451
