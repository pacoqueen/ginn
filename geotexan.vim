...
" Vim session script.
" Created by session.vim 2.13.1 on 14 noviembre 2016 at 17:28:40.
...
setlocal fen
silent! normal! zE
let s:l = 6162 - ((2 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
6162
...
setlocal fen
silent! normal! zE
let s:l = 1198 - ((1 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1198
...
setlocal fen
silent! normal! zE
let s:l = 528 - ((35 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
528
...
setlocal fen
silent! normal! zE
let s:l = 2705 - ((2 * winheight(0) + 2) / 4)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2705
