...
" Created by session.vim 1.5 on 28 enero 2014 at 17:15:18.
...
badd +0 ginn/formularios/checklist_window.py
...
20452
normal! zo
let s:l = 14952 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14952
...
413
normal! zo
let s:l = 392 - ((20 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
392
