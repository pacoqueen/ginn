...
" Created by session.vim 1.5 on 18 julio 2013 at 11:50:04.
...
873
silent! normal zo
let s:l = 921 - ((11 * winheight(0) + 6) / 13)
...
1921
silent! normal zo
let s:l = 1937 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1937
...
11694
silent! normal zo
let s:l = 7842 - ((10 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
7842
