...
" Created by session.vim 1.5 on 12 marzo 2014 at 17:15:47.
...
21040
normal! zo
let s:l = 9869 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9869
...
595
normal! zo
let s:l = 397 - ((0 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
397
...
1136
normal! zo
let s:l = 1031 - ((2 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1031
