...
" Created by session.vim 1.5 on 16 septiembre 2014 at 17:30:58.
...
exe 'vert 12resize ' . ((&columns * 85 + 59) / 118)
argglobal
enew
file __Tag_List__
setlocal fdm=manual
...
184
normal! zo
let s:l = 192 - ((17 * winheight(0) + 13) / 26)
