...
" Vim session script.
" Created by session.vim 2.13.1 on 29 enero 2018 at 18:21:32.
...
badd +1457 formularios/control_personal.py
argglobal
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 32 + 91) / 182)
exe '2resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 2resize ' . ((&columns * 149 + 91) / 182)
exe '3resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 3resize ' . ((&columns * 149 + 91) / 182)
exe '4resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 4resize ' . ((&columns * 149 + 91) / 182)
exe '5resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 5resize ' . ((&columns * 149 + 91) / 182)
exe '6resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 6resize ' . ((&columns * 149 + 91) / 182)
exe '7resize ' . ((&lines * 1 + 25) / 50)
exe 'vert 7resize ' . ((&columns * 149 + 91) / 182)
exe '8resize ' . ((&lines * 36 + 25) / 50)
exe 'vert 8resize ' . ((&columns * 149 + 91) / 182)
argglobal
enew
file __Tagbar__.1
wincmd w
argglobal
let s:l = 4543 - ((1 * winheight(0) + 0) / 1)
...
wincmd w
argglobal
edit formularios/productos_de_venta_balas.py
let s:l = 559 - ((1 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
559
...
wincmd w
argglobal
edit formularios/productos_de_venta_rollos.py
let s:l = 880 - ((1 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
880
...
let s:l = 1943 - ((11 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1943
