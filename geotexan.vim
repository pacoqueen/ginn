...
" Vim session script.
" Created by session.vim 2.13.1 on 28 noviembre 2017 at 09:46:20.
...
exe 'vert 1resize ' . ((&columns * 28 + 63) / 127)
exe '2resize ' . ((&lines * 13 + 28) / 57)
exe 'vert 2resize ' . ((&columns * 98 + 63) / 127)
exe '3resize ' . ((&lines * 13 + 28) / 57)
exe 'vert 3resize ' . ((&columns * 98 + 63) / 127)
exe '4resize ' . ((&lines * 13 + 28) / 57)
exe 'vert 4resize ' . ((&columns * 98 + 63) / 127)
exe '5resize ' . ((&lines * 13 + 28) / 57)
exe 'vert 5resize ' . ((&columns * 98 + 63) / 127)
argglobal
enew
file __Tagbar__.1
wincmd w
argglobal
let s:l = 102 - ((11 * winheight(0) + 6) / 13)
...
let s:l = 386 - ((3 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
386
...
let s:l = 405 - ((3 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
405
...
let s:l = 878 - ((4 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
878
