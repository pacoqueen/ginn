...
" Created by session.vim 1.5 on 26 marzo 2014 at 17:13:47.
...
badd +584 ginn/formularios/consulta_producido.py
...
21094
normal! zo
let s:l = 9938 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9938
...
458
normal! zo
let s:l = 461 - ((27 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
461
