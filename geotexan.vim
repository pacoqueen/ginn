...
" Created by session.vim 1.5 on 09 diciembre 2014 at 17:06:04.
...
16835
normal! zo
let s:l = 16897 - ((3 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16897
...
4176
normal! zo
let s:l = 1380 - ((10 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1380
