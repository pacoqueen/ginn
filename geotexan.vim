...
" Created by session.vim 1.5 on 05 noviembre 2014 at 21:39:43.
...
269
normal! zo
let s:l = 2319 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2319
...
3735
normal! zo
let s:l = 1779 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1779
...
3960
normal! zo
let s:l = 1687 - ((0 * winheight(0) + 2) / 4)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1687
