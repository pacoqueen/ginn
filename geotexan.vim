...
" Created by session.vim 1.5 on 30 septiembre 2014 at 16:25:00.
...
2182
normal! zo
let s:l = 2192 - ((21 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2192
...
971
normal! zo
let s:l = 209 - ((11 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
