...
" Created by session.vim 1.5 on 13 marzo 2014 at 16:20:27.
...
4242
normal! zo
let s:l = 4807 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4807
...
1153
normal! zo
let s:l = 658 - ((12 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
658
