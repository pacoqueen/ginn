...
" Created by session.vim 1.5 on 04 septiembre 2014 at 14:05:48.
...
badd +842 ginn/formularios/consulta_global.py
...
21544
normal! zo
let s:l = 10919 - ((0 * winheight(0) + 2) / 5)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10919
...
3960
normal! zo
let s:l = 1828 - ((0 * winheight(0) + 3) / 6)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1828
