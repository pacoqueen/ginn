...
" Created by session.vim 1.5 on 03 marzo 2014 at 22:09:32.
...
badd +114 ginn/formularios/balas_cable.py
...
310
normal! zo
let s:l = 110 - ((0 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
