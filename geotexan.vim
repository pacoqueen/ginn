...
" Created by session.vim 1.5 on 10 septiembre 2014 at 17:27:55.
...
exe 'vert 10resize ' . ((&columns * 83 + 56) / 112)
exe '11resize ' . ((&lines * 1 + 24) / 48)
exe 'vert 11resize ' . ((&columns * 83 + 56) / 112)
argglobal
enew
file __Tag_List__
setlocal fdm=manual
...
3461
normal! zo
let s:l = 316 - ((7 * winheight(0) + 14) / 28)
