...
" Vim session script.
" Created by session.vim 2.13.1 on 03 agosto 2017 at 12:04:11.
...
badd +2947 formularios/partes_de_fabricacion_rollos.py
...
badd +918 api/tests/ramanujan.py
argglobal
silent! argdel *
...
wincmd w
argglobal
let s:l = 742 - ((17 * winheight(0) + 12) / 24)
...
let s:l = 880 - ((10 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
880
