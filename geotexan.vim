...
" Vim session script.
" Created by session.vim 2.13.1 on 19 junio 2016 at 12:21:54.
...
exe 'vert 1resize ' . ((&columns * 33 + 67) / 134)
exe '2resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 100 + 67) / 134)
exe '3resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 100 + 67) / 134)
exe '4resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 100 + 67) / 134)
exe '5resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 100 + 67) / 134)
exe '6resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 100 + 67) / 134)
exe '7resize ' . ((&lines * 30 + 26) / 53)
exe 'vert 7resize ' . ((&columns * 100 + 67) / 134)
exe '8resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 8resize ' . ((&columns * 100 + 67) / 134)
argglobal
enew
file __Tagbar__
setlocal fdm=manual
...
setlocal fen
silent! normal! zE
let s:l = 464 - ((4 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
464
...
1resize 51|vert 1resize 33|2resize 1|vert 2resize 100|3resize 1|vert 3resize 100|4resize 1|vert 4resize 100|5resize 1|vert 5resize 100|6resize 1|vert 6resize 100|7resize 30|vert 7resize 100|8resize 10|vert 8resize 100|
7wincmd w
tabnext 1
if exists('s:wipebuf')
