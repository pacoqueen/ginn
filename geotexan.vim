...
" Vim session script.
" Created by session.vim 2.13.1 on 29 mayo 2017 at 17:04:31.
...
exe 'vert 1resize ' . ((&columns * 23 + 91) / 183)
exe '2resize ' . ((&lines * 12 + 27) / 54)
exe 'vert 2resize ' . ((&columns * 159 + 91) / 183)
exe '3resize ' . ((&lines * 12 + 27) / 54)
exe 'vert 3resize ' . ((&columns * 159 + 91) / 183)
exe '4resize ' . ((&lines * 12 + 27) / 54)
exe 'vert 4resize ' . ((&columns * 159 + 91) / 183)
exe '5resize ' . ((&lines * 13 + 27) / 54)
exe 'vert 5resize ' . ((&columns * 159 + 91) / 183)
argglobal
enew
file __Tagbar__.1
wincmd w
argglobal
let s:l = 141 - ((2 * winheight(0) + 6) / 12)
...
argglobal
edit api/murano/ops.py
let s:l = 2522 - ((5 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2522
...
let s:l = 118 - ((1 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
