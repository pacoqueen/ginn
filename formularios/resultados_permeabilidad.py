...
puntoglade = 'resultados_permeabilidad.glade'    # Archivo glade
claseprueba = pclases.PruebaPermeabilidad   # Clase de pclases.
nombrecampo = 'pruebasPermeabilidad'      # Campo de "partida".
nombreprueba = 'permeabilidad'  # Nombre de la prueba (media de resultados) en la partida.
titulo = 'Resultados de permeabilidad'
# XXX

class ResultadosPermeabilidad(Ventana):
