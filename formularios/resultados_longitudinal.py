...
puntoglade = 'resultados_longitudinal.glade'    # Archivo glade
claseprueba = pclases.PruebaLongitudinal    # Clase de pclases.
nombrecampo = 'pruebasResistenciaLongitudinal'       # Campo de "partida".
nombreprueba = 'longitudinal'   # Nombre de la prueba (media de resultados) en la partida.
titulo = 'Resultados de alargamiento longitudinal'
# XXX

class ResultadosLongitudinal(Ventana):
