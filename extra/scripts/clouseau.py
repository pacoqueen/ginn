...
EJEMPLO
./clouseau.py ../../tests/20140101_0600_existencias_iniciales_fib.csv \
              ../../tests/20140101_0600_existencias_iniciales_gtx.csv \
              ../../tests/20140101_0600_existencias_iniciales_cem.csv \
              ...
              ../../tests/20140201_0600_existencias_finales_cem.csv \
    ...
    for fproduccion in (fproduccion_fib, fproduccion_gtx, fproduccion_cem):
        ...
        for linea in data_in:
            ...
            if es_gtx:
                ...
                # Caso especial para producto C. Se mide en Kg. En mTotal
