...
def exportar_a(serviciostomados, dest):
    """
    «serviciostomados» es una lista de serviciostomados a exportar. 
    «dest» es un fichero destino donde se guardará la información de los 
    serviciostomados en formato CSV.
    """
