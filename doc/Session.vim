...
nmap [[ :PBoB
omap [[ :PBoB
map <silent> [c :call PythonDec("class", -1)
vmap ]> >
vmap ]< <
vmap ]] :PEoBm'gv``
nmap ]> [[V]]>
...
map ]v [[V]]
map <silent> gj :call PythonDec("function", 1)
map <silent> gk :call PythonDec("function", -1)
nmap gx <Plug>NetrwBrowseX
map <silent> vd :call PythonSelectObject("function")
map <silent> vc :call PythonSelectObject("class")
map <C-F5> :call StartOutline("vertical")
map <S-F5> :call StartOutline("horizontal")
map <F5> :call StartOutline("nosplit")
noremap <M-F5> :make %:clast:cl
...
map <S-F7> :exe ":sign jump 123 file=" . expand("%p")
map <C-F7> :exe ":sign unplace 123"
map <F7> :exe ":sign place 123 line=" . line(".") . " name=information file=" . expand("%:p")
map <S-Insert> <MiddleMouse>
imap <NL> <Plug>IMAP_JumpForward
abbr miemail rodriguez.bogado@gmail.com
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set smarttab
set spelllang=es,en
set statusline=%F%m%r%h%w\ [%{&ff}][%Y]\ [ASCII=%03.3b(0x%02.2B)]\ [POS=%04l,%04v][%p%%][LEN=%L]
...
silent only
cd ~/Q-INN/geotexan/geotexinn02/formularios
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1180 ../BD/tablas.sql
badd +48 ../informes/geninformes.py
badd +0 ~/Q-INN/INN22/doc/presupuesto/presupuesto.tex
badd +41 consulta_albaranesPorFacturar.py
badd +0 ../framework/pclases.py
badd +0 trazabilidad_articulos.py
args ../BD/tablas.sql
edit ~/Q-INN/INN22/doc/presupuesto/presupuesto.tex
...
noremap <buffer> ± :call CheckPythonSyntax():cl
setlocal noarabic
setlocal autoindent
setlocal autoread
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 6226 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
6226
...
wincmd w
argglobal
edit trazabilidad_articulos.py
noremap <buffer> ± :call CheckPythonSyntax():cl
setlocal noarabic
setlocal autoindent
setlocal autoread
...
wincmd w
argglobal
edit consulta_albaranesPorFacturar.py
noremap <buffer> ± :call CheckPythonSyntax():cl
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 318 - ((6 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
318
